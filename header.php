<nav class="navbar navbar-expand navbar-dark bg-primary sticky-top">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
        ...
        <li class="nav-item dropdown ">
            ...
            <li><a class="dropdown-item" href="logout"><i class="bi bi-box-arrow-left"></i> Logout/Keluar</a></li>
            </ul>
        </li>
        </ul>
    </div>
...
<div class="form-floating mb-3">
    <input disabled type="email" class="form-control" id="floatingInput" placeholder="name@example.com" required name="username"  value="<?php echo $_SESSION['username_gakenz'] ?>">
...
<div class="form-floating mb-3">
    ...
    <label for="floatingInput">Ulangi Password Baruu</label>
    <div class="invalid-feedback">
        Masukkan Ulangi Password Baruu Yoooo.
        </div>
</div>
</div>
</div>
